...
<div id="content">
  ...
  <div class="admin show">
    ...
    <div class="actions">
      <a class="action" href="<?php echo url_for('/admin/auth_admins/edit.php?id=' . h(u($admin['id']))); ?>">Edit</a>
      <a class="action" href="<?php echo url_for('/admin/auth_admins/delete.php?id=' . h(u($admin['id']))); ?>">Delete</a>
    </div>
