<?php
    ...
    if(!isset($_GET['id'])) {
        redirect_to(url_for('/admin/auth_admins/index.php'));
    }
    $id = $_GET['id'];
    ...
    if(is_post_request()) {
        ...
        if($result === true) {
            ...
            redirect_to(url_for('/admin/auth_admins/show.php?id=' . $id));
        } else {
            $errors = $result;
        }
...
<div id="content">
  ...
  <div class="admin edit">
    ...
    <form action="<?php echo url_for('/admin/auth_admins/edit.php?id=' . h(u($id))); ?>" method="post">
      <dl>
        <dt>First name</dt>
